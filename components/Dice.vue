...
[data-side="1"] {
  transform: rotate3d(0, 0, 0, 90deg) translateZ(3em);
}

[data-side="2"] {
  transform: rotate3d(-1, 0, 0, 90deg) translateZ(3em);
}

[data-side="3"] {
  transform: rotate3d(0, 1, 0, 90deg) translateZ(3em);
}
...
[data-side="6"] {
  transform: rotate3d(1, 0, 0, 180deg) translateZ(3em);
}
